...
@onready var interactable_component: IntercatableComponent = $InteractableComponent
@onready var reward_marker: Marker2D = $Marker2D
...
func add_reward_scene() -> void:
	for scene in output_reward_scenes:
		...
		print("position: ", reward_position)
